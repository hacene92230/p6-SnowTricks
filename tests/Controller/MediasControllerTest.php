...
class MediasControllerTest extends WebTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = static::getContainer()->get('doctrine')->getRepository(Medias::class);
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'media[images]' => 'Testing',
            'media[videos]' => 'Testing',
            'media[figures]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'media[images]' => 'Something New',
            'media[videos]' => 'Something New',
            'media[figures]' => 'Something New',
        ]);
        ...
        self::assertSame('Something New', $fixture[0]->getFigures());
    }
